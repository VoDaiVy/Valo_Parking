...
const schema = new mongoose.Schema({
  type: { type: String, enum: ['MODIFY_PRICING', 'CREATE_TICKET_PACKAGE', 'UPDATE_TICKET_PACKAGE', 'UPDATE_USER_STATUS', 'SEND_NOTIFICATION', 'APPROVE_VEHICLE', 'CREATE_POLICY_DRAFT', 'ARCHIVE_POLICY', 'CHANGE_USER_ROLE', 'UPDATE_USER_PROFILE', 'ARCHIVE_TICKET_PACKAGE', 'CREATE_SERVICE', 'UPDATE_SERVICE', 'ARCHIVE_SERVICE'], required: true },
